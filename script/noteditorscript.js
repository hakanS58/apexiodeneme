...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // High-priority state evaluation inside DOMContentLoaded
let activeFirebaseUserId = null;
const runtimeSessionToken = localStorage.getItem("nodax-auth-user-session");
if (runtimeSessionToken) {
    try {
        const structuralIdentity = JSON.parse(runtimeSessionToken);
        activeFirebaseUserId = structuralIdentity.uid;
    } catch(err) {
        console.error(err);
    }
}
